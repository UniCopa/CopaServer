...
public class DatabaseUtil {
    ...
    public static void createNewDatabase(File directory)
	    throws CreateException, SQLException, ConnectException {
     ...
     * again automatically.
     */
    public static Connection getConnection(File database, boolean create)
	    throws ConnectException {
	Connection conn = null;
	try {
	    StringBuilder sb = new StringBuilder(protocol).append(database
		    .getCanonicalPath());
	    if (create) {
    ...
    public static Connection getConnection(File database)
	    throws ConnectException {
     ...
     * https://svn.apache
     * .org/repos/asf/db/derby/code/trunk/java/demo/simple/SimpleApp.java
     */
    /**
     ...
     * 
     * @param e
     *            the SQLException from which to get details.
     */
