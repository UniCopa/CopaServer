 ...
 */
public class GetCurrentSingleEventsRequestHandler extends RequestHandler {

    public GetCurrentSingleEventsRequestHandler(CopaSystemContext context) {
	super(context);
    }
	...
	GetCurrentSingleEventsRequest req = (GetCurrentSingleEventsRequest) request;
	try {
	    List<SingleEvent> currentSingleEvents = getContext().getDbservice()
		    .getCurrentSingleEvents(req.getEventID(), req.getSince());
	    return new GetCurrentSingleEventsResponse(currentSingleEvents);
