...
import unicopa.copa.base.com.request.GetServerInfoResponse;
 ...
 */
public class GetServerInfoRequestHandler extends RequestHandler {

    public GetServerInfoRequestHandler(CopaSystemContext context) {
	super(context);
    }
	...
	return new GetServerInfoResponse(getContext().getServerInfo());
    }
}
