 ...
 */
public class GetMyEventsRequestHandler extends RequestHandler {

    public GetMyEventsRequestHandler(CopaSystemContext context) {
	super(context);
    }
	...
	try {
	    return new GetMyEventsResponse(getContext().getDbservice()
