...
public class GetEventRequestHandler extends RequestHandler {
    ...
    public GetEventRequestHandler(CopaSystemContext context) {
	super(context);
    }
	...
	GetEventRequest req = (GetEventRequest) request;
	try {
	    Event event = getContext().getDbservice()
		    .getEvent(req.getEventID());
