...
import unicopa.copa.base.com.request.GetUserDataResponse;
 ...
 */
public class GetUserDataRequestHandler extends RequestHandler {

    public GetUserDataRequestHandler(CopaSystemContext context) {
	super(context);
    }
	...
	GetUserDataRequest req = (GetUserDataRequest) request;
	try {
	    return new GetUserDataResponse(getContext().getDbservice()
		    .getUserData(userID));
