...
import unicopa.copa.base.com.request.GetMyAppointedUsersResponse;
 ...
 */
public class GetMyAppointedUsersRequestHandler extends RequestHandler {

    public GetMyAppointedUsersRequestHandler(CopaSystemContext context) {
	super(context);
    }
	...
	try {
	    return new GetMyAppointedUsersResponse(getContext().getDbservice()
